...
class PaymentProviderPlaid(models.Model):
    ...
    code = fields.Selection(selection_add=[
        ('plaid_manual', 'Plaid (Bank Transfer)')
    ...
    ], string="Plaid Environment", default='sandbox',
       help="Plaid environment to use (Sandbox for testing, Development or Production).")
    plaid_client_id = fields.Char("Plaid Client ID", help="Client ID provided by Plaid")
    plaid_secret = fields.Char("Plaid Secret", help="Secret Key provided by Plaid")
    ...
    def _should_build_inline_form(self, is_validation=False):
        ...
        return super(PaymentProviderPlaid, self)._should_build_inline_form(is_validation)
